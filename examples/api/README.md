# API-level API Management diagnostic example

This example attaches a diagnostic to an API Management API using the root module from `examples/api/main.tf`.

The repository Makefile generates `provider.tf` when you run `make lint` or `make test` from the repository root. Sign in to Azure first.
...
| <a name="module_apim_api"></a> [apim\_api](#module\_apim\_api) | terraform.registry.launch.nttdata.com/module_primitive/api_management_api/azurerm | ~> 1.0 |
| <a name="module_apim_diagnostic"></a> [apim\_diagnostic](#module\_apim\_diagnostic) | ../.. | n/a |
| <a name="module_apim_logger"></a> [apim\_logger](#module\_apim\_logger) | terraform.registry.launch.nttdata.com/module_primitive/api_management_logger/azurerm | ~> 1.0 |
...
| <a name="input_api_display_name"></a> [api\_display\_name](#input\_api\_display\_name) | display name of the API | `string` | `null` | no |
| <a name="input_api_name"></a> [api\_name](#input\_api\_name) | name of the API | `string` | `null` | no |
| <a name="input_api_path"></a> [api\_path](#input\_api\_path) | path of the API | `string` | `null` | no |
| <a name="input_api_revision"></a> [api\_revision](#input\_api\_revision) | revision of the API | `string` | `null` | no |
...
| <a name="input_resource_names_map"></a> [resource\_names\_map](#input\_resource\_names\_map) | A map of key to resource\_name that will be used by tf-launch-module\_library-resource\_name to generate resource names | <pre>map(object(<br/>    {<br/>      name       = string<br/>      max_length = optional(number, 60)<br/>    }<br/>  ))</pre> | <pre>{<br/>  "api_management": {<br/>    "max_length": 50,<br/>    "name": "apim"<br/>  },<br/>  "app_insights": {<br/>    "max_length": 50,<br/>    "name": "appinsights"<br/>  },<br/>  "log_analytics_workspace": {<br/>    "max_length": 50,<br/>    "name": "law"<br/>  },<br/>  "resource_group": {<br/>    "max_length": 50,<br/>    "name": "rg"<br/>  }<br/>}</pre> | no |
...
| Name | Description |
|------|-------------|
| <a name="output_api_management_api_name"></a> [api\_management\_api\_name](#output\_api\_management\_api\_name) | The name of the API Management Service |
