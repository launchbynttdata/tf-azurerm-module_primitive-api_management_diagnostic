# Service-level API Management diagnostic example

This example attaches a diagnostic to an API Management instance using the root module from `examples/service/main.tf`.
